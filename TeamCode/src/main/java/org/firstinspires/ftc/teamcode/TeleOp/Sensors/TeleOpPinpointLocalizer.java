...
public class TeleOpPinpointLocalizer {

    private final TeleOpGoBildaPinpointDriver odo;

    public TeleOpPinpointLocalizer(HardwareMap hardwareMap) {

        // Name "odo" must match your config name
        odo = hardwareMap.get(TeleOpGoBildaPinpointDriver.class, "odo");
        ...
        odo.setEncoderResolution(
                TeleOpGoBildaPinpointDriver.GoBildaOdometryPods.goBILDA_4_BAR_POD);
        ...
        odo.setEncoderDirections(
                TeleOpGoBildaPinpointDriver.EncoderDirection.FORWARD,
                TeleOpGoBildaPinpointDriver.EncoderDirection.FORWARD);
