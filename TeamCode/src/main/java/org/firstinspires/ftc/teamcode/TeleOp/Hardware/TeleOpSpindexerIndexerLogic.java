...
public class TeleOpSpindexerIndexerLogic {
    ...
    public TeleOpSpindexerIndexerLogic(LinearOpMode opMode,
                                       TeleOpSpindexerMotor motor,
                                       TeleOpMagneticLimitSwitch limit,
