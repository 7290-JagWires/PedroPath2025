...
@TeleOp(name = "RedTeleOpMain", group = "Linear Opmode")
public class RedTeleOpMain extends LinearOpMode {

    private static final int LAUNCH_DELAY_MILLISECONDS = 1000;

    public boolean tagDetectionLogicHasRun = false;
    private int redPipeline = 2;   //Red Pipeline
    ...
    public void runOpMode() {
        ...
        robot.limelight.setPipeline(redPipeline);
