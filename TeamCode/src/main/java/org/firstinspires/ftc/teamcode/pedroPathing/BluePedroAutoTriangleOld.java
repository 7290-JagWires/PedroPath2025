...
@Disabled
public class BluePedroAutoTriangleOld extends OpMode {
    ...
    */
    ...
    private final Pose pickup1Pose = new Pose(42, 37, Math.toRadians(180));
    private final Pose endPickup1Pose = new Pose(23, 37, Math.toRadians(180));
